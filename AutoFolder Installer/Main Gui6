...
Deutsch:=["Über","Einstellungen","Checkbox","Allgemein","Box123","Werksein- stellungen","Änderungen speichern","Änderungen verwerfen","Leere Ordner verschieben","Leere Ordner löschen","Leere Ordner überspringen","nach","Durch suchen","Konfiguration öffnen","Source Code ansehen","Verwerfen","Abbrechen","Speichern","Sie haben ungespeicherte Veränderrungen!","Ja","Nein"]

English:=["About","Settings","Checkbox","General","Box123","Default settings","Save changes","Cancel changes","Move empty folders","Delete empty folders","Skip empty folders","to","Browse","Open Config","View source code","Discard","Cancel","Save","There are unsaved changes!","Yes","No"]

Français:=["A propos","Paramètres","Case à cocher","Général","Boîte123","Paramètres par défaut","Sauvegarder les modifications","Annuler les modifications","Déplacer les dossiers vides","Supprimer les dossiers vides","Ne changez pas les dossiers vides","vers","Parcourir","Ouvrez Config","Afficher le code source","jeter","Annuler","Sauvegarder","Il y a des changements non sauvés!","Oui","Non"]

PossibleLanguage:=["English","Deutsch","Français"]
...
;==============================SETUP FUNCTIONS==============================
	...
	OptionEmptyFoldersOriginalSettings:=OptionEmptyFolders ;!!!!!!!!!!!!!!!
...
Update2:
	...
	if(DropDownEmptyFolders=%LanguageIni%[11])
	{
	...
	if(DropDownEmptyFolders=%LanguageIni%[10])
	{
	GuiControl 2:disable, Edit2
	GuiControl 2:hide, Edit2
	GuiControl 2:hide, % %LanguageIni%[12]
	...
	else if(DropDownEmptyFolders=%LanguageIni%[9])
	{
	...
	if(OptionEmptyFoldersOriginalSettings!=DropDownEmptyFolders)
	{
	GuiControl 2:enable, CancelChanges
	GuiControl 2:enable, SaveChanges
	ChangedSettings:=1
...
IfChangesReversed: 
	...
	if(OnOffOriginalSettings=OnOff && OptionEmptyFoldersOriginalSettings = English[LanguageArrayLoopVar] && OptionLanguageOriginalSettings=DropDownLanguage && IniPathOriginalSettings=NewPath && IniPath2OriginalSettings=NewPath2)
	{
        ;MsgBox, yes
        GuiControl 2:disable, CancelChanges
        GuiControl 2:disable, SaveChanges
