...
GuiClose:
    ...
    Gui 1Close:add, Text, y40, Are you sure that you want to cancel the installation?
    Gui 1Close:add, Button,gYesClose hwndYesClose, Yes
    Gui 1Close:add, Button,gNoClose hwndNoClose, No
    Gui 1Close:-SysMenu
    Gui 1Close:show, w300 h100, Cancel Installation?
