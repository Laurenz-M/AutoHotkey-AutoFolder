...
CloseAndSaveChanges:
    ;ReloadGui(LanguageIni,HwndSettingsWindow)
	OnOffOriginalSettings:=OnOff
	if(NewPath!=""){
...
DefaultSettingsYes:
    ReloadGui(LanguageIni,HwndSettingsWindow, DefaultSettingshwnd)
...
ReloadGui(LanguageIni,AdditionalOwnershipParam*){
    ...
    if(ShowReloadGui = 0){
		...
		Gui 5:add, CheckBox, hwndShowAgainhwnd Checked0, Dont show again ;% %LanguageIni%[1]
