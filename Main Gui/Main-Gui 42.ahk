...
;/*
    ...
    Gui 2:Add, Edit, w50 x165 y50 hwndUpDownEditHwnd gWhileFocused, 5
    ;msgbox, 1
    Gui 2:Add, UpDown, -16 hwndUpDownHwnd vMyUpDown Range%RangeMinUpDown%-%RangeMaxUpDown% Wrap, 5
...
UpdateContent:  ;Updates the content of updown's edit after it changed
    ...
    if(CurrentContentEdit = "ERROR"){   ;checks if formated content is valid
        GuiControl,, %UpDownEditHwnd%, %MyUpDown%
